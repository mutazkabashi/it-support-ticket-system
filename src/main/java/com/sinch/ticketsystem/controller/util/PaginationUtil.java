package com.sinch.ticketsystem.controller.util;
...
public class PaginationUtil {
	...
	//copied from 
	//https://github.com/jhipster/jhipster-bom/blob/main/jhipster-framework/src/main/java/tech/jhipster/web/util/PaginationUtil.java
